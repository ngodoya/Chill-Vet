...
COLUMNAS_MASCOTAS = ["id_mascota", "nombre", "especie", "raza", "edad", "sexo", "peso", "id_dueno"]
COLUMNAS_CITAS = ["id_cita", "fecha_hora", "motivo", "estado", "id_mascota", "id_veterinario"]
...
def guardar_citas(lista_citas):
    df = pd.DataFrame([i.to_dict(FORMATO_FECHA_HORA) for i in lista_citas], columns=COLUMNAS_CITAS)
